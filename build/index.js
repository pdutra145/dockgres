...
import fs from "fs";
var program = new Command("dockgres");
...
program
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(service == "postgresql")) return [3 /*break*/, 2];
                return [4 /*yield*/, actions(".env", postgres, postgresQuestions)];
            case 1:
                _a.sent();
                return [3 /*break*/, 5];
            case 2:
                if (!(service == "pgadmin")) return [3 /*break*/, 4];
                return [4 /*yield*/, actions(".env", pgadmin, pgadminQuestions)];
            case 3:
                _a.sent();
                return [3 /*break*/, 5];
            case 4: throw new Error("Invalid Service");
